...
/************************* sha384-512.c ************************/
/***************** See <a href="./rfc6234">RFC 6234</a> for details. *******************/
...
/*
 * These definitions are the ones used in FIPS 180-3, <a href="#section-4.1.3">section 4.1.3</a>
 *  Ch(x,y,z)   ((x & y) ^ (~x & z))
 */
 ...
 * used in FIPS 180-3, <a href="#section-4.1.3">section 4.1.3</a>.
 *   ((x & y) ^ (~x & z)) becomes
 *   ((x & (y ^ z)) ^ z)
 */
#define SHA_Ch(x, y, z, ret) (                                 \
...
/* Initial Hash Values: FIPS 180-3 sections <a href="#section-5.3.4">5.3.4</a> and <a href="#section-5.3.5">5.3.5</a> */
...
{
#ifdef USE_32BIT_ONLY
	/* Constants defined in FIPS 180-3, <a href="#section-4.2.3">section 4.2.3</a> */
